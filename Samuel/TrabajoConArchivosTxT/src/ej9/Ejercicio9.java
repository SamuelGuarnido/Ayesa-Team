	...
	public static void main(String[] args) {
		...
		try (BufferedReader in = new BufferedReader(
			...
			try (BufferedReader in2 = new BufferedReader(new FileReader(
					"C:\\Users\\samue\\eclipse-workspace\\TrabajoConArchivosTxT\\ficheros\\textocifrado.txt"))) {
				...
				try (BufferedWriter out = new BufferedWriter(new FileWriter(
						"C:\\Users\\samue\\eclipse-workspace\\TrabajoConArchivosTxT\\ficheros\\textoDescifrado.txt"))) {
					out.write(txt);
